...
################################################################################
## Form generated from reading UI file 'sound_upload.ui'
##
...
class Ui_upload_menu(object):
    def setupUi(self, upload_menu):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icon--select--sprite.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/icons/add_sound.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
