...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/help.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icon--play.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_run.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/icon--stop-all.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/icon--fullscreen.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_full_screen.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/btn_preview_prev.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_preview_prev.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/btn_preview_play.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon10.addFile(u":/icons/btn_preview_pause.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.btn_preview_play.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/btn_preview_next.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_preview_next.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/btn_preview_scale.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_preview_scale.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/btn_preview_change_bg.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_preview_change_bg.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/btn_preview_add.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_preview_add.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/\u56fe\u7247\u5e93.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_list_open.setIcon(icon15)
        self.btn_res_list_open.setIconSize(QSize(20, 20))
        self.btn_res_list_open.setFlat(True)

        self.horizontalLayout_14.addWidget(self.btn_res_list_open, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/icons/\u4e0a\u4f20\u672c\u5730\u56fe\u7247\u8d44\u6e90.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_list_upload.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/icons/\u9009\u4e2d\u5220\u9664.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_list_del.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/icons/\u91cd\u7f6e.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_list_clear.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/icons/\u79fb\u52a8\u951a\u70b9.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_col_move.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/\u6dfb\u52a0\u951a\u70b9.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_col_add.setIcon(icon20)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/icons/\u5220\u9664\u951a\u70b9.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_col_del.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/icons/\u91cd\u7f6e\u951a\u70b9.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_col_reset.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/icons/\u5438\u9644\u951a\u70b9.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_res_col_snap.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/icons/\u65b0\u5efa\u5730\u56fe.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_new.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/icons/\u5bfc\u5165\u5730\u56fe.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_import.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u":/icons/\u5bfc\u51fa\u5730\u56fe.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_export.setIcon(icon26)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/icons/\u79fb\u52a8\u5de5\u5177.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_move.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/icons/\u9009\u53d6\u5de5\u5177.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_select.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/icon--paint.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_draw.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/icons/\u6e05\u7a7a.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_erase.setIcon(icon30)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/icons/\u663e\u793a\u7f51\u683c.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_gird.setIcon(icon31)
        ...
        self.btn_editor_map_layer_image.setIcon(icon15)
        ...
        self.btn_editor_map_layer_tiled.setIcon(icon14)
        ...
        self.btn_editor_map_layer_del.setIcon(icon17)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icons/\u4e0a\u79fb\u56fe\u5c42.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_layer_up.setIcon(icon32)
        ...
        icon33 = QIcon()
        icon33.addFile(u":/icons/\u4e0b\u79fb\u56fe\u5c42.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_editor_map_layer_down.setIcon(icon33)
        ...
        self.fullscreen_btn_run.setIcon(icon6)
        ...
        self.fullscreen_btn_stop.setIcon(icon7)
        ...
        icon34 = QIcon()
        icon34.addFile(u":/icons/icon--unfullscreen.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.fullscreen_btn_unfull.setIcon(icon34)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_save.setText(QCoreApplication.translate("Form", u"\u63d2\u4ef6", None))
