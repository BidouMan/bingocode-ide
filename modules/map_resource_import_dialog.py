...
class MapResourceImportDialog(QDialog):
    ...
    def _update_ui_state(self):
        """更新UI状态"""
        # 根据资源类型启用/禁用尺寸选择
        self.ui.label_2.setEnabled(self.resource_type == "tileset")
        self.ui.comboBox_size.setEnabled(self.resource_type == "tileset")
    ...
    def get_import_data(self):
        ...
        return {
            ...
            "tile_size": self.tile_size if self.resource_type == "tileset" else None
        }